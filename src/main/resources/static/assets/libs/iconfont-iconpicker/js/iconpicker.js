...
! function(e) {
    ...
    function(e) {
        ...
        c._idCounter = 0, c.defaultOptions = {
            ...
            icons: [
                {title: "iconfont icon-time-o", searchTerms: []},
                {title: "iconfont icon-jinbi", searchTerms: []},
                {title: "iconfont icon-hide-line", searchTerms: []},
                {title: "iconfont icon-competence", searchTerms: []},
                {title: "iconfont icon-user-rights", searchTerms: []},
                {title: "iconfont icon-security", searchTerms: []},
                {title: "iconfont icon-phone-num", searchTerms: []},
                {title: "iconfont icon-key-circle", searchTerms: []},
                {title: "iconfont icon-lock", searchTerms: []},
                {title: "iconfont icon-unlock", searchTerms: []},
                {title: "iconfont icon-location", searchTerms: []},
                {title: "iconfont icon-back", searchTerms: []},
                {title: "iconfont icon-min-app", searchTerms: []},
                {title: "iconfont icon-qr", searchTerms: []},
                {title: "iconfont icon-upload", searchTerms: []},
                {title: "iconfont icon-down", searchTerms: []},
                {title: "iconfont icon-facebook-f", searchTerms: []},
                {title: "iconfont icon-google", searchTerms: []},
                {title: "iconfont icon-twitter", searchTerms: []},
                {title: "iconfont icon-alipay", searchTerms: []},
                {title: "iconfont icon-dingtalk", searchTerms: []},
                {title: "iconfont icon-huawei", searchTerms: []},
                {title: "iconfont icon-gitee", searchTerms: []},
                {title: "iconfont icon-random", searchTerms: []},
                {title: "iconfont icon-minipanel", searchTerms: []},
                {title: "iconfont icon-home", searchTerms: []},
                {title: "iconfont icon-diandian", searchTerms: []},
                {title: "iconfont icon-dian", searchTerms: []},
                {title: "iconfont icon-seting", searchTerms: []},
                {title: "iconfont icon-upload-wd", searchTerms: []},
                {title: "iconfont icon-add", searchTerms: []},
                {title: "iconfont icon-subtract", searchTerms: []},
                {title: "iconfont icon-collection-line", searchTerms: []},
                {title: "iconfont icon-nothing", searchTerms: []},
                {title: "iconfont icon-nothing1", searchTerms: []},
                {title: "iconfont icon-modify", searchTerms: []},
                {title: "iconfont icon-tvbox", searchTerms: []},
                {title: "iconfont icon-wailian", searchTerms: []},
                {title: "iconfont icon-book-mark-line", searchTerms: []},
                {title: "iconfont icon-book", searchTerms: []},
                {title: "iconfont icon-buy_car", searchTerms: []},
                {title: "iconfont icon-phone", searchTerms: []},
                {title: "iconfont icon-baidu", searchTerms: []},
                {title: "iconfont icon-refresh", searchTerms: []},
                {title: "iconfont icon-mac", searchTerms: []},
                {title: "iconfont icon-app", searchTerms: []},
                {title: "iconfont icon-jt-line-r", searchTerms: []},
                {title: "iconfont icon-chakan-line", searchTerms: []},
                {title: "iconfont icon-version-Line", searchTerms: []},
                {title: "iconfont icon-ad-line", searchTerms: []},
                {title: "iconfont icon-ad-copy", searchTerms: []},
                {title: "iconfont icon-shijian", searchTerms: []},
                {title: "iconfont icon-huabanfuben", searchTerms: []},
                {title: "iconfont icon-en", searchTerms: []},
                {title: "iconfont icon-cn", searchTerms: []},
                {title: "iconfont icon-zouxiang", searchTerms: []},
                {title: "iconfont icon-qushitubiao", searchTerms: []},
                {title: "iconfont icon-tubiaopeizhi", searchTerms: []},
                {title: "iconfont icon-zip", searchTerms: []},
                {title: "iconfont icon-ubuntu", searchTerms: []},
                {title: "iconfont icon-app-store-fill", searchTerms: []},
                {title: "iconfont icon-android", searchTerms: []},
                {title: "iconfont icon-linux", searchTerms: []},
                {title: "iconfont icon-app-store-fill-b", searchTerms: []},
                {title: "iconfont icon-microsoft", searchTerms: []},
                {title: "iconfont icon-loading", searchTerms: []},
                {title: "iconfont icon-goto", searchTerms: []},
                {title: "iconfont icon-yinhao-l", searchTerms: []},
                {title: "iconfont icon-yinhao-r", searchTerms: []},
                {title: "iconfont icon-picture", searchTerms: []},
                {title: "iconfont icon-book-mark", searchTerms: []},
                {title: "iconfont icon-url", searchTerms: []},
                {title: "iconfont icon-key", searchTerms: []},
                {title: "iconfont icon-tougao", searchTerms: []},
                {title: "iconfont icon-point", searchTerms: []},
                {title: "iconfont icon-chart-box", searchTerms: []},
                {title: "iconfont icon-renren", searchTerms: []},
                {title: "iconfont icon-links", searchTerms: []},
                {title: "iconfont icon-qqzone", searchTerms: []},
                {title: "iconfont icon-chart", searchTerms: []},
                {title: "iconfont icon-tiwwer", searchTerms: []},
                {title: "iconfont icon-douban", searchTerms: []},
                {title: "iconfont icon-chart-pc", searchTerms: []},
                {title: "iconfont icon-copy", searchTerms: []},
                {title: "iconfont icon-share", searchTerms: []},
                {title: "iconfont icon-facebook", searchTerms: []},
                {title: "iconfont icon-user", searchTerms: []},
                {title: "iconfont icon-heart", searchTerms: []},
                {title: "iconfont icon-instructions", searchTerms: []},
                {title: "iconfont icon-comment", searchTerms: []},
                {title: "iconfont icon-to-up", searchTerms: []},
                {title: "iconfont icon-business", searchTerms: []},
                {title: "iconfont icon-bulletin", searchTerms: []},
                {title: "iconfont icon-password", searchTerms: []},
                {title: "iconfont icon-related", searchTerms: []},
                {title: "iconfont icon-statement", searchTerms: []},
                {title: "iconfont icon-hot", searchTerms: []},
                {title: "iconfont icon-light", searchTerms: []},
                {title: "iconfont icon-night", searchTerms: []},
                {title: "iconfont icon-collection", searchTerms: []},
                {title: "iconfont icon-name", searchTerms: []},
                {title: "iconfont icon-like", searchTerms: []},
                {title: "iconfont icon-user-circle", searchTerms: []},
                {title: "iconfont icon-publish", searchTerms: []},
                {title: "iconfont icon-version", searchTerms: []},
                {title: "iconfont icon-notice", searchTerms: []},
                {title: "iconfont icon-chakan", searchTerms: []},
                {title: "iconfont icon-time", searchTerms: []},
                {title: "iconfont icon-crying-circle", searchTerms: []},
                {title: "iconfont icon-email", searchTerms: []},
                {title: "iconfont icon-category", searchTerms: []},
                {title: "iconfont icon-classification", searchTerms: []},
                {title: "iconfont icon-tags", searchTerms: []},
                {title: "iconfont icon-globe", searchTerms: []},
                {title: "iconfont icon-adopt", searchTerms: []},
                {title: "iconfont icon-crying", searchTerms: []},
                {title: "iconfont icon-warning", searchTerms: []},
                {title: "iconfont icon-smiley-circle", searchTerms: []},
                {title: "iconfont icon-close-circle", searchTerms: []},
                {title: "iconfont icon-close", searchTerms: []},
                {title: "iconfont icon-tishi", searchTerms: []},
                {title: "iconfont icon-smiley", searchTerms: []},
                {title: "iconfont icon-arrow-l", searchTerms: []},
                {title: "iconfont icon-arrow-t", searchTerms: []},
                {title: "iconfont icon-arrow-r-m", searchTerms: []},
                {title: "iconfont icon-arrow-r", searchTerms: []},
                {title: "iconfont icon-arrow-b", searchTerms: []},
                {title: "iconfont icon-tag", searchTerms: []},
                {title: "iconfont icon-weibo", searchTerms: []},
                {title: "iconfont icon-git", searchTerms: []},
                {title: "iconfont icon-qr-sweep", searchTerms: []},
                {title: "iconfont icon-search", searchTerms: []},
                {title: "iconfont icon-wechat", searchTerms: []},
                {title: "iconfont icon-github", searchTerms: []},
                {title: "iconfont icon-qq", searchTerms: []},
