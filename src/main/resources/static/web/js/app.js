    ...
    $(document).on('mouseenter', '.mini-sidebar .sidebar-nav .sidebar-menu ul:first>li,.mini-sidebar .sidebar-nav .flex-bottom ul:first>li', function () {
        ...
        _this.one('mouseleave', function () {
            if ($('body').hasClass('mini-sidebar') && $('.sidebar-scroll').innerHeight() > $('.sidebar-menu').innerHeight()) {
                $('.mini-sidebar .sidebar-nav .sidebar-menu').one('mouseleave', function () {
                    sidebar_second.hide();
                })
            } else {
                sidebar_second.hide();
...
function showAlert(data) {
    ...
    let msg = data.msg;
    let alert_placeholder = $('#alert_placeholder');
    if (!alert_placeholder[0]) {
        $('body').append('<div id="alert_placeholder" class="alert-system"></div>')
        alert_placeholder = $('#alert_placeholder');
    }
    let $html = $('<div class="alert-body text-sm io-alert-' + alert + ' alert alert-' + alert + ' d-flex py-2 align-items-center"><i class="iconfont ' + ico + ' text-lg mr-2"></i><span class="mr-2">' + msg + '</span></div>');
