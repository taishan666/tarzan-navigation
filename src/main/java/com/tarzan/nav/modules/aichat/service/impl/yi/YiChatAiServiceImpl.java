package com.tarzan.nav.modules.aichat.service.impl.yi;
 ...
 */
@Service
public class YiChatAiServiceImpl extends AbsChatAiService {
    ...
    public Flux<ChatRecordsVo> doAsyncAnswer(Integer userId, ChatRecordsVo response) {
        ...
        return WEB_CLIENT.post().uri("rpc/2.0/ai_custom/v1/wenxinworkshop/chat/yi_34b_chat?access_token=" + getAccessToken()).contentType(MediaType.APPLICATION_JSON)
