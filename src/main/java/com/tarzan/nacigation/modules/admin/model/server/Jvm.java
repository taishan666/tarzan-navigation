...
public class Jvm
{
    ...
    {
        return DateUtil.parseDateToStr(DateUtil.datetimeFormat,DateUtil.getServerStartDate());
    }
    ...
    public String getRunTime() {
        return DateUtil.getDatePoor(DateUtil.now(), DateUtil.getServerStartDate());
    }
